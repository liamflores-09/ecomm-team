...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        @if($isAdmin)
            ...
            {{-- ── Content & Catalog ── --}}
            <li style="padding:12px 12px 4px;font-size:0.65rem;font-weight:700;text-transform:uppercase;letter-spacing:0.07em;color:var(--muted-foreground);pointer-events:none;">Content</li>
            ...
            <li><a href="{{ route('team') }}"           class="{{ $active === 'team'            ? 'active' : '' }}"><i class="fas fa-users-viewfinder"></i> The Team</a></li>
            <li><a href="{{ route('dashboard') }}"      class="{{ $active === 'dashboard'       ? 'active' : '' }}"><i class="fas fa-house"></i> Member View</a></li>
